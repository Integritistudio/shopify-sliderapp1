...
//     console.log("Creating slider:", { name, sliderType })
...
//     console.log(`Updating slider ${id}:`, { name, isExpanded, sliderType })
...
//     console.log(`Adding slide to slider ${sliderId}:`, { imageUrl, title, description })
...
//     console.log(`Created slide ${slide.id} for slider ${sliderId}`)
...
//     const { imageUrl, title, description } = req.body
//     console.log(`Updating slide ${slideId} in slider ${sliderId}`)
...
//   try {
//     const { sliderId, slideId } = req.params
//     console.log(`Deleting slide ${slideId} from slider ${sliderId}`)
