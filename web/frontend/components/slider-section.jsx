...
//   onDeleteSlider,
//   onRefresh,
//   // Add this new prop from the parent
//   onUpdateSliderType,
// }) {
...
//   // Ensure slides is always an array with valid slide objects
...
//           {/* Header */}
//           <div style={{ cursor: "pointer" }} onClick={() => onToggleExpanded(slider.id)}>
...
//                 ) : (
//                   <Stack alignment="center" spacing="tight">
//                     <Text variant="headingMd">{slider.name}</Text>
//                     <Button
//                       plain
//                       size="slim"
//                       onClick={(e) => {
...
//             {/* ===== THIS IS THE FIX ===== */}
//             {/* Only render the content when the slider is expanded */}
//             {slider.isExpanded && (
//               <div style={{ marginTop: "1rem" }}>
//                 <Stack vertical spacing="loose">
//                   {/* Slider Display - Only show if there are slides */}
//                   {slides.length > 0 ? (
//                     <DynamicSlickSlider
//                       slides={slides}
//                       sliderId={slider.id}
//                       sliderType={slider.sliderType || "center"}
//                       // Add a unique key to force re-initialization when data changes
...
//                         <Text variant="headingMd" color="subdued">No Slides Yet</Text>
...
//         onUpdateSliderType={(newType) => onUpdateSliderType(slider.id, newType)}
//       />
//       <AddToThemeModal
