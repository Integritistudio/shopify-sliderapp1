...
// import { Page, Stack, Heading, Button, Text, Badge, Toast, Frame } from "@shopify/polaris"
...
//       // Backend returns 'slides' array, not 'Slides'
...
//         shop: slider.shop, // Include shop field
//         slides: Array.isArray(slider.slides)
//           ? slider.slides.filter(slide => slide && slide.id).map(slide => ({
//               id: slide.id,
...
//       console.log("Validated sliders:", validatedSliders)
...
//       showToast(`Error fetching sliders: ${err.message}`, true)
//     } finally {
//       setIsLoading(false)
//     }
//   }
...
//       // Add the new slider to state with proper structure
...
//       showToast(`Failed to create slider: ${err.message}`, true)
//     }
//   }
...
//       console.log("Updated slider expansion:", updatedSlider)

//       setSliders(prev =>
//         prev.map(slider => 
//           slider.id === sliderId 
//             ? { ...slider, isExpanded: updatedSlider.isExpanded }
//             : slider
//         )
//       )
//     } catch (err) {
//       console.error("Toggle expansion error:", err)
//       showToast(`Failed to update slider: ${err.message}`, true)
//     }
//   }
...
//       showToast(`Failed to add slide: ${err.message}`, true)
...
//     try {
//       // Find which slider contains this slide
//       const slider = sliders.find(s => 
//         s.slides && s.slides.some(slide => slide.id === updatedSlide.id)
//       )
...
//       console.log("Updated slide:", updatedSlideData)
...
//       showToast(`Failed to update slide: ${err.message}`, true)
//       throw err
//     }
//   }
...
//       console.log(`Successfully deleted slide ${slideId} from slider ${sliderId}`)
...
//       showToast(`Failed to delete slide: ${err.message}`, true)
//       throw err
//     }
//   }
...
//       const updatedSlider = await response.json()
//       console.log("Updated slider name:", updatedSlider)
      
//       setSliders(prev =>
//         prev.map(slider => 
//           slider.id === sliderId 
//             ? { ...slider, name: updatedSlider.name, updatedAt: updatedSlider.updatedAt }
//             : slider
//         )
//       )
...
//       showToast(`Failed to update slider name: ${err.message}`, true)
//       throw err
//     }
//   }
...
//       const updatedSlider = await response.json()
//       console.log("Updated slider type:", updatedSlider)
...
//       showToast(`Failed to update slider type: ${err.message}`, true)
//       throw err
//     }
//   }
...
//       console.log(`Successfully deleted slider ${sliderId}`)
...
//       showToast(`Failed to delete slider: ${err.message}`, true)
//       throw err
//     }
//   }
...
//                 borderTop: "3px solid #007c65", 
//                 borderRadius: "50%", 
//                 animation: "spin 1s linear infinite" 
//               }} />
//               <Text variant="headingMd" color="subdued">Loading sliders...</Text>
//             </Stack>
//           </div>
//         </Page>
//         <style jsx>{`
...
//                 <Badge status="success">{sliders.length} Slider{sliders.length !== 1 ? 's' : ''}</Badge>
//                 <Badge status="info">{totalSlides} Total Slide{totalSlides !== 1 ? 's' : ''}</Badge>
//               </Stack>
//             </Stack>
//           </div>
...
//                       Create your first slider to get started! You can add beautiful image sliders 
//                       to showcase your products and content.
//                     </Text>
