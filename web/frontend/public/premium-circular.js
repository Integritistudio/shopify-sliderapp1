...
(function (global) {
  ...
  var CSS = [
    ...
    '  .se-pcc__slide.is-active .se-pcc-card--has-hover:hover .se-pcc-card__image--hover,',
    '  .se-pcc__slide.is-active .se-pcc-card--has-hover:hover .se-product-card__img--hover,',
    '  .se-pcc__slide.is-active .se-product-card--has-hover:hover .se-pcc-card__image--hover,',
    '  .se-pcc__slide.is-active .se-product-card--has-hover:hover .se-product-card__img--hover {',
    '    opacity: 1;',
    '  }',
    '}',
    ...
    '}',
    '@media (hover: hover) and (pointer: fine) {',
    '  .se-pcc__slide.is-active .se-pcc-card--quick-add:hover .se-product-card__quick-add,',
    '  .se-pcc__slide.is-active .se-product-card--quick-add:hover .se-product-card__quick-add {',
    '    opacity: 1;',
    '    pointer-events: auto;',
    '  }',
    '}',
    '@media (hover: none), (pointer: coarse) {',
    '  .se-pcc__slide.is-active .se-pcc-card__media .se-product-card__quick-add {',
    '    opacity: 1;',
    '    pointer-events: auto;',
    '  }',
    '}',
    ...
    '  z-index: 2;',
    '  margin: 0;',
    '  padding: var(--pcc-sales-badge-pad, 8px);',
    '  font-size: 0.625rem;',
    '  font-weight: 700;',
    '  letter-spacing: 0.12em;',
    '  text-transform: uppercase;',
    '  color: var(--pcc-surface);',
    '  background: var(--pcc-sales-badge-bg, #170f49);',
    '  border-radius: 2px;',
    '}',
