...
(function (global) {
  ...
  var CSS = [
    ...
    '  .se-pcf-card--has-hover:hover .se-pcf-card__image--hover,',
    '  .se-pcf-card--has-hover:hover .se-product-card__img--hover,',
    '  .se-product-card--has-hover:hover .se-pcf-card__image--hover,',
    ...
    '}',
    '@media (hover: hover) and (pointer: fine) {',
    '  .se-pcf-card--quick-add:hover .se-product-card__quick-add,',
