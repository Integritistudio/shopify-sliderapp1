export const SLIDER_TYPES = [
  ...
  { value: "premium-stacked", label: "3D Stacked Cards", description: "Product cards stacked in depth — swipe to reveal the next", group: "Premium" },
  { value: "testimonials-3d", label: "3D Testimonials", description: "Floating depth quote cards with stars, avatar, and verified badge", group: "Premium" },
  { value: "ugc-feed", label: "3D UGC Feed", description: "Instagram-style vertical UGC cards with shoppable CTAs — video or image", group: "Premium" },
  { value: "logo-3d", label: "3D Brand Logos", description: "Cylindrical trusted-by / partners logo carousel with depth", group: "Premium" },
